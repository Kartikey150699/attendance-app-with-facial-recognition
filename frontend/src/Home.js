        ...
        {!showCamera ? (
          <div className="flex justify-between w-full px-32 -mt-20 gap-10">
            <button
              ...
              className="flex-1 h-48 bg-green-500 hover:bg-green-600 hover:scale-105 active:scale-95 transition-transform duration-200 text-white text-4xl font-semibold rounded-xl shadow-md flex flex-col items-center justify-center"
            >
            ...
            <button
              ...
              className="flex-1 h-48 bg-yellow-400 hover:bg-yellow-500 hover:scale-105 active:scale-95 transition-transform duration-200 text-white text-4xl font-semibold rounded-xl shadow-md flex flex-col items-center justify-center"
            >
            ...
            <button
              ...
              className="flex-1 h-48 bg-red-500 hover:bg-red-600 hover:scale-105 active:scale-95 transition-transform duration-200 text-white text-4xl font-semibold rounded-xl shadow-md flex flex-col items-center justify-center"
            >
