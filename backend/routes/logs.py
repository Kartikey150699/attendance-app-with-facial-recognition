...
class AttendanceUpdate(BaseModel):
    ...
    edited_by: Optional[str] = "admin"  # will be replaced by real admin name
...
def update_attendance(
    ...
    # Insert AuditLog only if something changed
    if changes:
        audit = AuditLog(
...
def export_logs(
    ...
    if format == "csv":
        ...
        # Header row: logo | title | metadata
